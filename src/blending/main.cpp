...
int main()
{
    ...
    // CUBE 1
    Plane cube = Plane(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(.5f, .5f, .5f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    ...
    // CUBE 2
    Plane cube2 = Plane(glm::vec3(1.3f, 0.5f, 0.0f), glm::vec3(.9f, .9f, .9f), glm::vec3(90.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    // Plane 3
    Plane cube3 = Plane(glm::vec3(3.3f, 0.5f, 0.0f), glm::vec3(.4f, .4f, .4f), glm::vec3(0.0f, 90.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    // Plane 4
    Plane cube4 = Plane(glm::vec3(5.3f, 0.5f, 0.0f), glm::vec3(.4f, .4f, .4f), glm::vec3(0.0f, 0.0f, 90.0f), glm::vec3(1.0f, 0.f, 0.f));
    // Plane 5
    Plane cube5 = Plane(glm::vec3(7.3f, 0.5f, 0.0f), glm::vec3(.4f, .4f, .4f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    // Plane 6
    Plane cube6 = Plane(glm::vec3(12.3f, 0.5f, 0.0f), glm::vec3(.4f, .4f, .4f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));

    // CUBES LIST
    //THE ORDER MATTERS
    std::vector<Plane> cubes;
    ...
    // TEXTURE
    unsigned int diffuseMap = loadTexture("/home/loe/raytracer/resources/window.png");
    unsigned int specularMap = loadTexture("/home/loe/raytracer/resources/container2_specular.png");
    unsigned int floorDiffuseMap = loadTexture("/home/loe/raytracer/resources/floor.jpeg");
    unsigned int floorSpecularMap = loadTexture("/home/loe/raytracer/resources/floor_specular.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // LIGHTS
        // directional light
        lightingShader.setVec3("dirLight.direction", -0.2f, 10.0f, -0.3f);
        ...
        // FLOOR
        // material
        lightingShader.setInt("material.texture_diffuse1", 2);
        lightingShader.setInt("material.texture_specular1", 3);
