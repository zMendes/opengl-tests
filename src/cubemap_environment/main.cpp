...
int main()
{
    ...
    std::vector<std::string> faces{
        "/home/loe/raytracer/resources/skybox/right.jpg",
        "/home/loe/raytracer/resources/skybox/left.jpg",
        "/home/loe/raytracer/resources/skybox/top.jpg",
        "/home/loe/raytracer/resources/skybox/bottom.jpg",
        "/home/loe/raytracer/resources/skybox/front.jpg",
        "/home/loe/raytracer/resources/skybox/back.jpg"};
    unsigned int cubemapTexture = loadCubemap(faces);
    // SKYBOX
    Skybox skybox = Skybox(glm::vec3(0.f, 0.f, 0.0f), glm::vec3(1.f, 1.f, 1.f), glm::vec3(90.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    // skybox VAO
    ...
    glBufferData(GL_ARRAY_BUFFER, skybox.get_vertices().size() * sizeof(float), skybox.get_vertices().data(), GL_STATIC_DRAW);
