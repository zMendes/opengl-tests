...
int main()
{
    ...
    Shader lightBoxShader("light_box.vs", "light_box.fs");

    Model cyborg("/home/loe/raytracer/resources/cyborg/cyborg.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightBoxShader.setVec3("viewPos", camera.Position);
        for (unsigned int i = 0; i < lightPositions.size(); i++)
        {
            model = glm::mat4(1.0f);
