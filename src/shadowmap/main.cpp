...
int main()
{
    ...
    //CUBE 1
    Cube cube1 = Cube(glm::vec3(.0f, 1.0f, 0.0f), glm::vec3(1.0f, 1.f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    //CUBE 1
    Cube cube2 = Cube(glm::vec3(.0f, 3.0f, 1.0f), glm::vec3(1.0f, 1.f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    //CUBE 1
    Cube cube3 = Cube(glm::vec3(1.0f, 1.0f, 0.60f), glm::vec3(1.0f, 1.f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.f, 0.f));
    ...
    glBufferData(GL_ARRAY_BUFFER, floor.get_vertices().size() * sizeof(float), floor.get_vertices().data(), GL_STATIC_DRAW);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //CUBE 1
         //  model matrix
        lightingShader.setMat4("model", cube1.get_model_matrix());
        glDrawArrays(GL_TRIANGLES, 0, 36);
        //CUBE2
         //  model matrix
        lightingShader.setMat4("model", cube2.get_model_matrix());
        glDrawArrays(GL_TRIANGLES, 0, 36);
        //CUBE3
         //  model matrix
        lightingShader.setMat4("model", cube3.get_model_matrix());
        glDrawArrays(GL_TRIANGLES, 0, 36);
